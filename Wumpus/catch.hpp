...
std::ostream &
operator<< (std::ostream &, Catch_global_namespace_dummy);
...
namespace Catch {
    ...
    public: // named queries
        ...
        auto
        numberOfCharacters () const noexcept -> size_type;
    ...
    auto operator+ (StringRef const &lhs,
...
namespace Catch {
    ...
    operator| (ResultDisposition::Flags lhs,
...
namespace Catch {
    namespace Detail {
        ...
        std::string rawMemoryToString (const T &object) {
            return rawMemoryToString(&object,
                                     sizeof(object));
        }
    ...
    struct StringMaker<std::wstring> {
        static std::string
        convert (const std::wstring &wstr);
    };
...
# endif
    ...
    struct StringMaker<T *> {
        ...
        static std::string convert (U *p) {
            if (p) {
                return ::Catch::Detail::rawMemoryToString(
                        p);
            } else {
                return "nullptr";
            }
...
namespace Catch {
    ...
    std::string rangeToString (Range const &range) {
        return ::Catch::Detail::rangeToString(begin(range),
                                              end(range));
    }
...
#else
            std::strftime(timeStamp, timeStampSize, fmt,
                          timeInfo);
#endif
...
namespace Catch {
    ...
    struct ITransientExpression {
        auto
        isBinaryExpression () const -> bool { return m_isBinaryExpression; }

        auto getResult () const -> bool { return m_result; }

        virtual void streamReconstructedExpression (
    ...
    public:
        BinaryExpr (bool comparisonResult, LhsT lhs,
    ...
    public:
        ...
        auto operator== (
            ...
            return {compareEqual(m_lhs, rhs), m_lhs, "==",
                    rhs};
        }
        ...
        auto operator!= (
                RhsT const &rhs) -> BinaryExpr<LhsT, RhsT const &> const {
            return {compareNotEqual(m_lhs, rhs), m_lhs,
                    "!=", rhs};
        }
    ...
    void
    handleExpression (ITransientExpression const &expr);
...
namespace Catch {
    ...
    struct IResultCapture {
        ...
        virtual bool
        sectionStarted (SectionInfo const &sectionInfo,
                        Counts &assertions) = 0;
        ...
        virtual void
        handleFatalErrorCondition (StringRef message) = 0;
...
namespace Catch {
    ...
    public:
        ...
        LazyExpression &
        operator= (LazyExpression const &) = delete;
...
namespace Catch {
    ...
    public:
        ...
        auto
        getElapsedMilliseconds () const -> unsigned int;
...
namespace Catch {
    ...
    struct IRegistryHub {
        ...
        getReporterRegistry () const = 0;

        virtual ITestCaseRegistry const &
        getTestCaseRegistry () const = 0;
    ...
    struct IMutableRegistryHub {
        ...
        virtual void
        registerTest (TestCase const &testInfo) = 0;
...
namespace Catch {
    ...
    struct IExceptionTranslatorRegistry {
        ...
        virtual std::string
        translateActiveException () const = 0;
    };
...
namespace Catch {
    namespace Detail {
        ...
        private:
            bool
            equalityComparisonImpl (double other) const;
        ...
        public:
            ...
            template<typename T, typename = typename std::enable_if<std::is_constructible<double, T>::value>::type>
            explicit Approx (T const &value): Approx(
    ...
    struct StringMaker<Catch::Detail::Approx> {
        static std::string
        convert (Catch::Detail::Approx const &value);
    };
...
#    pragma clang diagnostic ignored "-Wnon-virtual-dtor"
            ...
            struct MatcherMethod {
                virtual bool
                match (ObjectT const &arg) const = 0;
            };
...
#    pragma clang diagnostic pop
            ...
            template<typename T>
            struct MatcherBase
                    : MatcherUntypedBase, MatcherMethod<T> {
    ...
    namespace Matchers {
        ...
        namespace Floating {
            ...
            struct WithinAbsMatcher : MatcherBase<double> {
                WithinAbsMatcher (double target,
                                  double margin);

                bool
                match (double const &matchee) const override;
            ...
            struct WithinUlpsMatcher : MatcherBase<double> {
                WithinUlpsMatcher (double target, int ulps,
...
namespace Catch {
    namespace Matchers {
        namespace Generic {
            ...
            namespace Detail {
                std::string finalizeDescription (
            ...
            public:
                ...
                PredicateMatcher (std::function<bool (
                        T const &)> const &elem,
                                  std::string const &descr)
                        : m_predicate(std::move(elem)),
                          m_description(
                                  Detail::finalizeDescription(
                                          descr)) {}
    ...
    namespace Matchers {
        ...
        namespace StdString {
            ...
            struct RegexMatcher : MatcherBase<std::string> {
                ...
                bool
                match (std::string const &matchee) const override;
...
namespace Catch {
    namespace Matchers {
            ...
            struct UnorderedEqualsMatcher
                ...
                match (std::vector<T> const &vec) const override {
                    ...
                    for (auto mid = lfirst;
                        ...
                        if (Detail::contains(lfirst, mid,
                                             *mid)) {
                            continue;
                        }
                        size_t num_vec = Detail::count(
                                rfirst, rlast, *mid);
                        if (num_vec == 0 ||
                            Detail::count(lfirst, llast,
                                          *mid) !=
                            num_vec) {
                            return false;
                        }
        ...
        VectorContains (T const &comparator) {
            return Vector::ContainsElementMatcher<T>(
                    comparator);
        }
        ...
        UnorderedEquals (std::vector<T> const &target) {
            return Vector::UnorderedEqualsMatcher<T>(
                    target);
        }
...
namespace Catch {
    ...
    makeMatchExpr (ArgT const &arg, MatcherT const &matcher,
        ...
        return MatchExpr<ArgT, MatcherT>(arg, matcher,
                                         matcherString);
    }
...
namespace Catch {
    namespace Generators {
        ...
        class SingleValueGenerator : public IGenerator<T> {
            T m_value;
        public:
            SingleValueGenerator (T const &value) : m_value(
                    value) {}
        ...
        struct NullGenerator : IGenerator<T> {
            auto get (size_t) const -> T override {
                CATCH_INTERNAL_ERROR(
                        "A Null Generator is always empty");
            }
        };
        ...
        std::vector<size_t>
        randomiseIndices (size_t selectionSize,
                          size_t sourceSize);
        ...
        public:
            GeneratorRandomiser (
                    Generator<T> &&baseGenerator,
                    size_t numberOfItems)
                    : m_baseGenerator(
                    std::move(baseGenerator)),
                      m_indices(randomiseIndices(
                              numberOfItems,
                              m_baseGenerator.size())) {}
        ...
        template<typename T>
        auto
        all () -> Generator<T> { return RequiresASpecialisationFor<T>(); }

        template<>
        auto all<int> () -> Generator<int>;

        template<typename T>
        auto range (T const &first,
                    T const &last) -> Generator<T> {
            return Generator<T>((last - first),
                                pf::make_unique<RangeGenerator<T>>(
                                        first, last));
        }

        template<typename T>
        auto random (T const &first,
                     T const &last) -> Generator<T> {
            auto gen = range(first, last);
            auto size = gen.size();

            return Generator<T>(size,
                                pf::make_unique<GeneratorRandomiser<T>>(
                                        std::move(gen),
                                        size));
        }
        ...
        template<typename T>
        auto
        values (std::initializer_list<T> values) -> Generator<T> {
            return Generator<T>(values.size(),
                                pf::make_unique<FixedValuesGenerator<T>>(
                                        values));
        }
        ...
        template<typename T>
        auto as () -> Generator<T> {
            return Generator<T>(0,
                                pf::make_unique<NullGenerator<T>>());
        }

        template<typename... Ts>
        auto
        table (std::initializer_list<std::tuple<Ts...>> &&tuples) -> Generator<std::tuple<Ts...>> {
            return values<std::tuple<Ts...>>(
                    std::forward<std::initializer_list<std::tuple<Ts...>>>(
                            tuples));
        }
        ...
        struct Generators : GeneratorBase {
            ...
            void populate (U &&valueOrGenerator,
                           Gs... moreGenerators) {
                populate(std::forward<U>(valueOrGenerator));
                populate(std::forward<Gs>(
                        moreGenerators)...);
            }
            ...
            auto operator[] (size_t index) const -> T {
                ...
                CATCH_INTERNAL_ERROR("Index '" << index
                                               << "' is out of range ("
                                               << sizes
                                               << ')');
            }
        ...
        auto makeGenerators (Generator<T> &&generator,
            ...
            generators.m_generators.reserve(
                    1 + sizeof...(Gs));
...
namespace Catch {
    ...
    public:
        ...
        TestCase
        withName (std::string const &_newName) const;
...
namespace Catch {
    ...
    private:
        std::string
        adjustCase (std::string const &str) const;
    ...
    class TestSpec {
        struct Pattern {
            ...
            virtual bool matches (
                    TestCaseInfo const &testCase) const = 0;
        };
        ...
        public:
            ...
            virtual bool matches (
                    TestCaseInfo const &testCase) const override;
        ...
        struct Filter {
            ...
            bool
            matches (TestCaseInfo const &testCase) const;
        };
...
namespace Catch {
    ...
    struct ITagAliasRegistry {
        ...
        virtual TagAlias const *
        find (std::string const &alias) const = 0;
...
namespace Catch {
    ...
    public:
        TestSpecParser (
                ITagAliasRegistry const &tagAliases);
    ...
    private:
        ...
        void addPattern () {
            ...
            for (std::size_t i = 0;
                 i < m_escapeChars.size(); ++i)
                token = token.substr(0, m_escapeChars[i] -
                                        m_start - i) +
                        token.substr(
                                m_escapeChars[i] - m_start -
                                i + 1);
            m_escapeChars.clear();
            ...
            if (!token.empty()) {
                TestSpec::PatternPtr pattern = std::make_shared<T>(
                        token);
                if (m_exclusion)
                    pattern = std::make_shared<TestSpec::ExcludedPattern>(
                            pattern);
                m_currentFilter.m_patterns.push_back(
                        pattern);
            }
            m_exclusion = false;
            m_mode = None;
...
namespace Catch {
    ...
    struct IConfig : NonCopyable {
        ...
        virtual bool
        warnAboutMissingAssertions () const = 0;
        ...
        virtual int
        benchmarkResolutionMultiple () const = 0;
...
#undef CATCH_CONFIG_DEFAULT_REPORTER
    ...
    public:
        ...
        getTestsOrTags () const;

        std::vector<std::string> const &
        getSectionsToRun () const override;
...
namespace Catch {
    ...
    public:
        ...
        T const &
        operator* () const { return *nullableValue; }
        ...
        T valueOr (T const &defaultValue) const {
            return nullableValue ? *nullableValue
                                 : defaultValue;
        }
...
namespace Catch {
    ...
    struct AssertionStats {
        ...
        AssertionStats &
        operator= (AssertionStats const &) = default;

        AssertionStats &
        operator= (AssertionStats &&) = default;
    ...
    struct SectionStats {
        ...
        SectionStats &
        operator= (SectionStats const &) = default;
    ...
    struct TestCaseStats {
        ...
        TestCaseStats &
        operator= (TestCaseStats const &) = default;

        TestCaseStats &
        operator= (TestCaseStats &&) = default;
    ...
    struct TestGroupStats {
        ...
        TestGroupStats &
        operator= (TestGroupStats const &) = default;

        TestGroupStats &
        operator= (TestGroupStats &&) = default;
    ...
    struct TestRunStats {
        ...
        TestRunStats &
        operator= (TestRunStats const &) = default;
    ...
    struct IStreamingReporter {
        ...
        virtual ReporterPreferences
        getPreferences () const = 0;

        virtual void
        noMatchingTestCases (std::string const &spec) = 0;

        virtual void testRunStarting (
                TestRunInfo const &testRunInfo) = 0;

        virtual void
        testGroupStarting (GroupInfo const &groupInfo) = 0;
        ...
        virtual void
        skipTest (TestCaseInfo const &testInfo) = 0;
...
namespace Catch {
    ...
    struct StreamingReporterBase : IStreamingReporter {
        ...
        void testRunStarting (
                TestRunInfo const &_testRunInfo) override {
            currentTestRunInfo = _testRunInfo;
        }

        void testGroupStarting (
                GroupInfo const &_groupInfo) override {
            currentGroupInfo = _groupInfo;
        }

        void testCaseStarting (
                TestCaseInfo const &_testInfo) override {
            currentTestCaseInfo = _testInfo;
        }

        void sectionStarting (
                SectionInfo const &_sectionInfo) override {
            m_sectionStack.push_back(_sectionInfo);
        }

        void sectionEnded (
                SectionStats const & /* _sectionStats */) override {
            m_sectionStack.pop_back();
        }

        void testCaseEnded (
                TestCaseStats const & /* _testCaseStats */) override {
            currentTestCaseInfo.reset();
        }

        void testGroupEnded (
                TestGroupStats const & /* _testGroupStats */) override {
            currentGroupInfo.reset();
        }

        void testRunEnded (
                TestRunStats const & /* _testRunStats */) override {
            currentTestCaseInfo.reset();
            currentGroupInfo.reset();
    ...
    struct CumulativeReporterBase : IStreamingReporter {
        ...
        struct Node {
            explicit Node (T const &_value) : value(
                    _value) {}
        ...
        struct SectionNode {
            explicit SectionNode (
                    SectionStats const &_stats) : stats(
                    _stats) {}
            ...
            bool operator== (
                    std::shared_ptr<SectionNode> const &other) const {
        ...
        struct BySectionInfo {
            ...
            bool operator() (
                    std::shared_ptr<SectionNode> const &node) const {
        ...
        void sectionStarting (
                SectionInfo const &sectionInfo) override {
            SectionStats incompleteStats(sectionInfo,
                                         Counts(), 0,
                                         false);
        ...
        void assertionStarting (
                AssertionInfo const &) override {}

        bool assertionEnded (
                AssertionStats const &assertionStats) override {
            ...
            sectionNode.assertions.push_back(
                    assertionStats);
            return true;
        }

        void sectionEnded (
                SectionStats const &sectionStats) override {
            assert(!m_sectionStack.empty());
        ...
        void testCaseEnded (
                TestCaseStats const &testCaseStats) override {
            auto node = std::make_shared<TestCaseNode>(
                    testCaseStats);
        ...
        void testGroupEnded (
            ...
            auto node = std::make_shared<TestGroupNode>(
                    testGroupStats);
        ...
        void testRunEnded (
                TestRunStats const &testRunStats) override {
            auto node = std::make_shared<TestRunNode>(
                    testRunStats);
...
namespace Catch {
    ...
    struct CompactReporter
        ...
        void noMatchingTestCases (
                std::string const &spec) override;

        void
        assertionStarting (AssertionInfo const &) override;

        bool assertionEnded (
                AssertionStats const &_assertionStats) override;
...
namespace Catch {
    ...
    struct ConsoleReporter
            : StreamingReporterBase<ConsoleReporter> {
        ...
        void benchmarkStarting (
                BenchmarkInfo const &info) override;

        void benchmarkEnded (
                BenchmarkStats const &stats) override;
...
namespace Catch {
    ...
    public:
        ...
        XmlEncode (std::string const &str,
    ...
    public:
        ...
        public:
            ...
            template<typename T>
            ScopedElement &
            writeAttribute (std::string const &name,
                            T const &attribute) {
...
namespace Catch {
    ...
    public:
        ...
        void testRunStarting (
                TestRunInfo const &runInfo) override;

        void testGroupStarting (
                GroupInfo const &groupInfo) override;

        void testCaseStarting (
                TestCaseInfo const &testCaseInfo) override;
        ...
        void
        writeTestCase (TestCaseNode const &testCaseNode);
        ...
        void
        writeAssertions (SectionNode const &sectionNode);
...
namespace Catch {
    ...
    public:
        ...
        void
        writeSourceInfo (SourceLineInfo const &sourceInfo);

    public: // StreamingReporterBase

        void
        noMatchingTestCases (std::string const &s) override;

        void testRunStarting (
                TestRunInfo const &testInfo) override;

        void testGroupStarting (
                GroupInfo const &groupInfo) override;

        void testCaseStarting (
                TestCaseInfo const &testInfo) override;
...
namespace Catch {
    namespace TestCaseTracking {
        ...
        struct ITracker {
            ...
            // static queries
            virtual NameAndLocation const &
            nameAndLocation () const = 0;

            // dynamic queries
            virtual bool
            isComplete () const = 0; // Successfully completed or failed
            virtual bool
            isSuccessfullyCompleted () const = 0;

            virtual bool
            isOpen () const = 0; // Started but not complete
            ...
            // actions
            virtual void
            close () = 0; // Successfully complete
            virtual void fail () = 0;

            virtual void markAsNeedingAnotherRun () = 0;

            virtual void
            addChild (ITrackerPtr const &child) = 0;

            virtual ITrackerPtr findChild (
        ...
        public:
            ...
            nameAndLocation () const override;
            ...
            void
            addChild (ITrackerPtr const &child) override;

            ITrackerPtr findChild (
                    NameAndLocation const &nameAndLocation) override;
...
// But without the subtraction to allow for INFINITY in comparison
    bool marginComparison (double lhs, double rhs,
                           double margin) {
...
namespace Catch {
    namespace Detail {
        ...
        bool Approx::equalityComparisonImpl (
            ...
            return marginComparison(m_value, other,
                                    m_margin) ||
...
namespace Catch {
    ...
    class RunContext
            : public IResultCapture, public IRunner {
    ...
    public: // IResultCapture
        ...
        void sectionEnded (
                SectionEndInfo const &endInfo) override;

        void sectionEndedEarly (
                SectionEndInfo const &endInfo) override;
        ...
        void pushScopedMessage (
                MessageInfo const &message) override;

        void popScopedMessage (
                MessageInfo const &message) override;
        ...
        void handleFatalErrorCondition (
...
namespace Catch {
    ...
    LazyExpression::LazyExpression (
            LazyExpression const &other) : m_isNegated(
            other.m_isNegated) {}
    ...
    void AssertionHandler::handleExpr (
            ITransientExpression const &expr) {
        m_resultCapture.handleExpr(m_assertionInfo, expr,
                                   m_reaction);
    }
    ...
    AssertionHandler::handleExceptionThrownAsExpected () {
        m_resultCapture.handleNonExpr(m_assertionInfo,
                                      ResultWas::Ok,
                                      m_reaction);
    }
    ...
    handleExceptionMatchExpr (AssertionHandler &handler,
                              std::string const &str,
                              StringRef const &matcherString) {
        handleExceptionMatchExpr(handler,
                                 Matchers::Equals(str),
                                 matcherString);
    }
...
namespace Catch {
    ...
    AssertionResult::getExpressionInMacro () const {
        ...
        if (m_info.macroName[0] == 0)
            ...
            expr.reserve(m_info.macroName.size() +
                         m_info.capturedExpression.size() +
                         4);
    ...
    bool AssertionResult::hasExpandedExpression () const {
        return hasExpression() &&
               getExpandedExpression() != getExpression();
    }
        ...
        namespace TextFlow {
            ...
            public:
                class iterator {
                    ...
                    void calcLength () {
                        assert(m_stringIndex <
                               m_column.m_strings.size());

                        m_suffix = false;
                        auto width =
                                m_column.m_width - indent();
                        m_end = m_pos;
                        ...
                        if (m_end < m_pos + width) {
                            ...
                            size_t len = width;
                            while (len > 0 &&
                                   !isBoundary(m_pos + len))
                                --len;
                            while (len > 0 && isWhitespace(
                                    line()[m_pos + len -
                                           1]))
                                --len;
                    ...
                    auto indent () const -> size_t {
                        auto initial = m_pos == 0 &&
                                       ...
                                       : std::string::npos;
                        return initial == std::string::npos
                               ? m_column.m_indent
                               : initial;
                    }
                ...
                public:
                    ...
                    explicit iterator (Column const &column)
                        ...
                        assert(m_column.m_width >
                               m_column.m_indent);
                        assert(m_column.m_initialIndent ==
                               std::string::npos ||
                               m_column.m_width >
                               m_column.m_initialIndent);
                        calcLength();
                    ...
                    auto operator== (
                            iterator const &other) const -> bool {
                        return
                                m_pos == other.m_pos &&
                                m_stringIndex ==
                                other.m_stringIndex &&
                ...
                auto
                width () const -> size_t { return m_width; }
                ...
                auto
                operator+ (Column const &other) -> Columns;
    ...
    namespace clara {
        namespace detail {
            ...
            public:
                ...
                explicit operator bool () const {
                    return !m_tokenBuffer.empty() ||
                           it != itEnd;
                }

                auto count () const -> size_t {
                    return m_tokenBuffer.size() +
                           (itEnd - it);
                }
            ...
            protected:
                ResultValueBase (Type type) : ResultBase(
                        type) {}

                ResultValueBase (
                        ResultValueBase const &other)
                        : ResultBase(other) {
                ...
                auto operator= (
                        ResultValueBase const &other) -> ResultValueBase & {
                    if (m_type == ResultBase::Ok)
                        m_value.~T();
            ...
            public:
                ...
                static auto logicError (
                        std::string const &message) -> BasicResult {
                    return {ResultBase::LogicError,
                            message};
                }

                static auto runtimeError (
                        std::string const &message) -> BasicResult {
                    return {ResultBase::RuntimeError,
                            message};
                }
                ...
                auto
                type () const -> ResultBase::Type { return m_type; }

                auto
                errorMessage () const -> std::string { return m_errorMessage; }
            ...
            public:
                ...
                auto
                type () const -> ParseResultType { return m_type; }
            ...
            template<typename T>
            inline auto
            convertInto (std::string const &source,
            ...
            convertInto (std::string const &source,
                ...
                std::transform(srcLC.begin(), srcLC.end(),
                               srcLC.begin(), [] (char c) {
                            return static_cast<char>( ::tolower(
                                    c));
                        });
                if (srcLC == "y" || srcLC == "1" ||
                    srcLC == "true" || srcLC == "yes" ||
                    srcLC == "on")
                    target = true;
                else if (srcLC == "n" || srcLC == "0" ||
                         srcLC == "false" ||
                         srcLC == "no" || srcLC == "off")
                    target = false;
                else
    ...
    inline auto convertInto( std::string const &source, CLARA_CONFIG_OPTIONAL_TYPE<T>& target ) -> ParserResult {
        ...
        return result;
            ...
            struct BoundRef : NonCopyable {
                ...
                virtual auto
                isContainer () const -> bool { return false; }

                virtual auto
                isFlag () const -> bool { return false; }
            };
            ...
            struct BoundFlagRefBase : BoundRef {
                virtual auto
                setFlag (bool flag) -> ParserResult = 0;

                virtual auto
                isFlag () const -> bool { return true; }
            };
            ...
            struct BoundValueRef : BoundValueRefBase {
                ...
                explicit BoundValueRef (T &ref) : m_ref(
                        ref) {}

                auto setValue (
                        std::string const &arg) -> ParserResult override {
            ...
            struct BoundValueRef<std::vector<T>>
                ...
                auto
                isContainer () const -> bool override { return true; }
            ...
            struct BoundFlagRef : BoundFlagRefBase {
                ...
                explicit BoundFlagRef (bool &ref) : m_ref(
                        ref) {}

                auto setFlag (
                        bool flag) -> ParserResult override {
                    m_ref = flag;
                    return ParserResult::ok(
                            ParseResultType::Matched);
                }
            ...
            struct LambdaInvoker {
                ...
                static auto invoke (L const &lambda,
            ...
            public:
                ...
                virtual auto
                validate () const -> Result { return Result::ok(); }
                ...
                virtual auto
                cardinality () const -> size_t { return 1; }

                auto
                parse (Args const &args) const -> InternalParseResult {
                    return parse(args.exeName(),
                                 TokenStream(args));
                }
            };
            ...
            protected:
                ...
                explicit ParserRefImpl (
                        std::shared_ptr<BoundRef> const &ref)
                        : m_ref(ref) {}
            ...
            public:
                ...
                ParserRefImpl (T &ref,
                        ...
                        :   m_ref(
                        std::make_shared<BoundValueRef<T>>(
                                ref)),
                            m_hint(hint) {}

                template<typename LambdaT>
                ParserRefImpl (LambdaT const &ref,
                               std::string const &hint)
                        :   m_ref(
                ...
                auto
                hint () const -> std::string { return m_hint; }
            };
            ...
            public:
                ...
                explicit ExeName (std::string &ref)
                        : ExeName() {
                    m_ref = std::make_shared<BoundValueRef<std::string>>(
                            ref);
                }
                ...
                auto
                name () const -> std::string { return *m_name; }
            ...
            inline auto normaliseOpt (
                    std::string const &optName) -> std::string {
#ifdef CATCH_PLATFORM_WINDOWS
                                                                                                                                        if( optName[0] == '/' )
            ...
            public:
                template<typename LambdaT>
                explicit
                Opt (LambdaT const &ref) : ParserRefImpl(
                ...
                auto isMatch (
                        std::string const &optToken) const -> bool {
                    auto normalisedToken = normaliseOpt(
                            optToken);
                    for (auto const &name : m_optNames) {
                        if (normaliseOpt(name) ==
                            normalisedToken)
                            return true;
                    }
                    return false;
                ...
                auto parse (std::string const &,
                    ...
                    auto remainingTokens = tokens;
                    if (remainingTokens &&
                        remainingTokens->type ==
                        TokenType::Option) {
                        auto const &token = *remainingTokens;
                        if (isMatch(token.token)) {
                            if (m_ref->isFlag()) {
                                auto flagRef = static_cast<detail::BoundFlagRefBase *>( m_ref.get());
                                auto result = flagRef->setFlag(
                                        true);
                                if (!result)
                                    return InternalParseResult(
                                            result);
            ...
            struct Parser : ParserBase {
                ...
                writeToStream (std::ostream &os) const {
                    ...
                    for (auto const &cols : rows)
                        optWidth = (std::max) (optWidth,
                                cols.left.size() + 2);

                    optWidth = (std::min) (optWidth,
                            consoleWidth / 2);
                ...
                auto parse (std::string const &exeName,
                    ...
                    while (result.value().remainingTokens()) {
                        ...
                        for (size_t i = 0;
                            ...
                            if (parseInfo.parser->cardinality() ==
                                0 || parseInfo.count <
...
namespace Catch {
    ...
    makeCommandLineParser (ConfigData &config) {
        ...
        auto const loadTestNamesFromFile = [&] (
        ...
        auto const setRngSeed = [&] (
                std::string const &seed) {
            if (seed != "time")
                return clara::detail::convertInto(seed,
                                                  config.rngSeed);
            config.rngSeed = static_cast<unsigned int>( std::time(
                    nullptr));
            return ParserResult::ok(
                    ParseResultType::Matched);
        };
...
namespace Catch {
    ...
    bool
    Config::listTests () const { return m_data.listTests; }

    bool
    Config::listTestNamesOnly () const { return m_data.listTestNamesOnly; }

    bool
    Config::listTags () const { return m_data.listTags; }

    bool
    Config::listReporters () const { return m_data.listReporters; }

    std::string
    Config::getProcessName () const { return m_data.processName; }
    ...
    TestSpec const &
    Config::testSpec () const { return m_testSpec; }

    bool
    Config::hasTestFilters () const { return m_hasTestFilters; }

    bool
    Config::showHelp () const { return m_data.showHelp; }

    // IConfig interface
    bool
    Config::allowThrows () const { return !m_data.noThrow; }

    std::ostream &
    Config::stream () const { return m_stream->stream(); }

    std::string Config::name () const {
        return m_data.name.empty() ? m_data.processName
                                   : m_data.name;
    }
    ...
    Config::runOrder () const { return m_data.runOrder; }

    unsigned int
    Config::rngSeed () const { return m_data.rngSeed; }

    int
    Config::benchmarkResolutionMultiple () const { return m_data.benchmarkResolutionMultiple; }

    UseColour::YesOrNo
    Config::useColour () const { return m_data.useColour; }

    bool
    Config::shouldDebugBreak () const { return m_data.shouldDebugBreak; }

    int
    Config::abortAfter () const { return m_data.abortAfter; }

    bool
    Config::showInvisibles () const { return m_data.showInvisibles; }

    Verbosity
    Config::verbosity () const { return m_data.verbosity; }
...
namespace Catch {
    ...
    bool isDebuggerActive () {
        ...
        size = sizeof(info);
        if (sysctl(mib, sizeof(mib) / sizeof(*mib), &info,
                   &size, nullptr, 0) != 0) {
            Catch::cerr()
...
namespace Catch {
    ...
    void ExceptionTranslatorRegistry::registerTranslator (
        ...
        m_translators.push_back(
                std::unique_ptr<const IExceptionTranslator>(
                        translator));
    }
...
namespace Catch {
    ...
    void FatalConditionHandler::reset () {
        if (isSet) {
            ...
            for (std::size_t i = 0; i < sizeof(signalDefs) /
                                        sizeof(SignalDefs); ++i) {
                sigaction(signalDefs[i].id,
                          &oldSigActions[i], nullptr);
            }
...
namespace Catch {
    ...
    namespace Generators {
        ...
        randomiseIndices (size_t selectionSize,
            ...
            std::uniform_int_distribution<size_t> uid(0,
                                                      sourceSize -
                                                      1);
...
namespace Catch {
    ...
    public: // IStreamingReporter
        ...
        void benchmarkStarting (
                BenchmarkInfo const &benchmarkInfo) override;

        void benchmarkEnded (
                BenchmarkStats const &benchmarkStats) override;
...
namespace Catch {
    ...
    std::ostream &
    ReporterConfig::stream () const { return *m_stream; }
    ...
    bool
    IStreamingReporter::isMulti () const { return false; }
...
namespace Catch {
    ...
    std::size_t listTests (Config const &config) {
        ...
        auto matchedTestCases = filterTests(
                getAllTestCasesSorted(config), testSpec,
                config);
        for (auto const &testCaseInfo : matchedTestCases) {
            ...
            Catch::cout() << Column(
                    testCaseInfo.name).initialIndent(
                    2).indent(4) << "\n";
            if (config.verbosity() >= Verbosity::High) {
                Catch::cout() << Column(
                        Catch::Detail::stringify(
                                testCaseInfo.lineInfo)).indent(
                        4) << std::endl;
            ...
            if (!testCaseInfo.tags.empty())
                Catch::cout() << Column(
                        testCaseInfo.tagsAsString()).indent(
                        6) << "\n";
        }
...
namespace Catch {
    namespace Matchers {
        namespace Floating {
            ...
            // Performs equivalent check of std::fabs(lhs - rhs) <= margin
            // But without the subtraction to allow for INFINITY in comparison
            bool WithinAbsMatcher::match (
                    double const &matchee) const {
            ...
            WithinUlpsMatcher::WithinUlpsMatcher (
                    double target, int ulps,
                    FloatingPointKind baseType)
                    : m_target{target}, m_ulps{ulps},
                      m_type{baseType} {
...
#pragma clang diagnostic pop
            ...
            WithinUlpsMatcher::describe () const {
                return "is within " +
                       Catch::to_string(m_ulps) +
                       " ULPs of " +
                       ::Catch::Detail::stringify(
                               m_target) +
                       ((m_type == FloatingPointKind::Float)
                        ? "f" : "");
            }
        ...
        Floating::WithinAbsMatcher
        WithinAbs (double target, double margin) {
            return Floating::WithinAbsMatcher(target,
                                              margin);
        }
...
std::string
Catch::Matchers::Generic::Detail::finalizeDescription (
        const std::string &desc) {
    if (desc.empty()) {
    ...
    namespace Matchers {
        ...
        namespace StdString {
            ...
            EqualsMatcher::EqualsMatcher (
                    CasedString const &comparator)
                    : StringMatcherBase("equals",
                                        comparator) {}

            bool EqualsMatcher::match (
            ...
            ContainsMatcher::ContainsMatcher (
                    CasedString const &comparator)
                    : StringMatcherBase("contains",
                                        comparator) {}

            bool ContainsMatcher::match (
                    std::string const &source) const {
                return contains(
                        m_comparator.adjustString(source),
                        m_comparator.m_str);
            }

            StartsWithMatcher::StartsWithMatcher (
                    CasedString const &comparator)
                    : StringMatcherBase("starts with",
                                        comparator) {}

            bool StartsWithMatcher::match (
                    std::string const &source) const {
                return startsWith(
                        m_comparator.adjustString(source),
                        m_comparator.m_str);
            ...
            EndsWithMatcher::EndsWithMatcher (
                    CasedString const &comparator)
                    : StringMatcherBase("ends with",
                                        comparator) {}

            bool EndsWithMatcher::match (
                    std::string const &source) const {
                return endsWith(
                        m_comparator.adjustString(source),
                        m_comparator.m_str);
            ...
            bool RegexMatcher::match (
                    std::string const &matchee) const {
            ...
            std::string RegexMatcher::describe () const {
                return "matches " +
                       ::Catch::Detail::stringify(m_regex) +
                       ((m_caseSensitivity ==
        ...
        Matches (std::string const &regex,
                 CaseSensitive::Choice caseSensitivity) {
            return StdString::RegexMatcher(regex,
                                           caseSensitivity);
        }
...
//           case '>':
                ...
                case ',':
                    if (start != pos &&
                        openings.size() == 0) {
                        m_messages.emplace_back(macroName,
                                                lineInfo,
                                                resultType);
        ...
        m_messages.emplace_back(macroName, lineInfo,
                                resultType);
        m_messages.back().message = trimmed(start,
                                            names.size() -
                                            1);
        m_messages.back().message += " := ";
    }
    ...
    void Capturer::captureValue (size_t index,
                                 std::string const &value) {
...
namespace Catch {
    ...
    RedirectedStdOut::RedirectedStdOut () : m_cout(
            Catch::cout(), m_rss.get()) {}

    auto
    RedirectedStdOut::str () const -> std::string { return m_rss.str(); }
    ...
    auto
    RedirectedStdErr::str () const -> std::string { return m_rss.str(); }
...
namespace Catch {
    ...
    void enforceNoDuplicateTestCases (
            std::vector<TestCase> const &functions);
...
namespace Catch {
    ...
    struct TagAlias {
        TagAlias (std::string const &_tag,
...
namespace Catch {
    ...
    public:
        ...
        TagAlias const *
        find (std::string const &alias) const override;
    ...
    namespace {
        ...
        public: // IMutableRegistryHub
            void registerReporter (std::string const &name,
                ...
                m_reporterRegistry.registerReporter(name,
                                                    factory);
            }
            ...
            void registerTest (
                    TestCase const &testInfo) override {
            ...
            void registerTagAlias (std::string const &alias,
                ...
                m_tagAliasRegistry.add(alias, tag,
                                       lineInfo);
            }

            void
            registerStartupException () noexcept override {
                m_exceptionRegistry.add(
                        std::current_exception());
            }
...
namespace Catch {
    ...
    namespace Generators {
        struct GeneratorTracker
            ...
            GeneratorTracker (
                    ...
                    TrackerContext &ctx, ITracker *parent)
                    : TrackerBase(nameAndLocation, ctx,
                                  parent) {}
            ...
            bool
            isIndexTracker () const override { return true; }
            ...
            void setGenerator (
                    GeneratorBasePtr &&generator) override {
                m_generator = std::move(generator);
            }
    ...
    Totals RunContext::runTest (TestCase const &testCase) {
        ...
        do {
            ...
            runCurrentTest(redirectedCout, redirectedCerr);
                ...
                !m_testCaseTracker->isSuccessfullyCompleted() &&
                !aborting());
    ...
    void RunContext::assertionEnded (
        ...
        static_cast<void>(m_reporter->assertionEnded(
                AssertionStats(result, m_messages,
                               m_totals)));
    ...
    bool RunContext::testForMissingAssertions (
            Counts &assertions) {
    ...
    void RunContext::sectionEnded (
            SectionEndInfo const &endInfo) {
        Counts assertions = m_totals.assertions -
                            endInfo.prevAssertions;
        ...
        m_reporter->sectionEnded(
                SectionStats(endInfo.sectionInfo,
                             assertions,
    ...
    void RunContext::sectionEndedEarly (
            SectionEndInfo const &endInfo) {
    ...
    void RunContext::pushScopedMessage (
            MessageInfo const &message) {
        m_messages.push_back(message);
    }

    void RunContext::popScopedMessage (
            MessageInfo const &message) {
    ...
    void RunContext::handleFatalErrorCondition (
        ...
        AssertionResultData tempResult(
                ResultWas::FatalErrorCondition, {false});
        tempResult.message = message;
        AssertionResult result(m_lastAssertionInfo,
                               tempResult);
        ...
        m_reporter->testRunEnded(
                TestRunStats(m_runInfo, m_totals, false));
    }
    ...
    RunContext::runCurrentTest (std::string &redirectedCout,
        ...
        Counts assertions =
                m_totals.assertions - prevAssertions;
        bool missingAssertions = testForMissingAssertions(
                assertions);
    ...
    void RunContext::handleExpr (
        ...
        if (result) {
            if (!m_includeSuccessfulResults) {
                ...
                reportExpr(info, ResultWas::Ok, &expr,
                           negated);
            }
        } else {
            reportExpr(info, ResultWas::ExpressionFailed,
                       &expr, negated);
    ...
    void RunContext::populateReaction (
            AssertionReaction &reaction) {
...
namespace Catch {
    ...
    Section::Section (SectionInfo const &info)
            : m_info(info),
              m_sectionIncluded(
                      getResultCapture().sectionStarted(
                              m_info, m_assertions)) {
        m_timer.start();
    }
    ...
    Section::~Section () {
        if (m_sectionIncluded) {
            ...
            if (uncaught_exceptions())
                getResultCapture().sectionEndedEarly(
                        endInfo);
            else
...
namespace Catch {
    ...
    namespace {
        ...
        IStreamingReporterPtr
        createReporter (std::string const &reporterName,
        ...
        IStreamingReporterPtr makeReporter (
                std::shared_ptr<Config> const &config) {
            if (Catch::getRegistryHub().getReporterRegistry().getListeners().empty()) {
                return createReporter(
                        config->getReporterName(), config);
            }

            auto multi = std::unique_ptr<ListeningReporter>(
                    new ListeningReporter);

            auto const &listeners = Catch::getRegistryHub().getReporterRegistry().getListeners();
            for (auto const &listener : listeners) {
                multi->addListener(listener->create(
        ...
        runTests (std::shared_ptr<Config> const &config) {
            ...
            auto const &allTestCases = getAllTestCasesSorted(
                    *config);
            ...
            if (config->warnAboutNoTests() &&
                ...
                context.reporter().noMatchingTestCases(
                        testConfig.str());
                totals.error = -1;
            }
    ...
    int Session::applyCommandLine (int argc,
                                   char const *const *argv) {
        if (m_startupExceptions)
            return 1;
        ...
        if (!result) {
            Catch::cerr()
                    << Colour(Colour::Red)
                    << "\nError(s) in input:\n"
                    << Column(result.errorMessage()).indent(
                            2)
                    << "\n\n";
...
namespace Catch {
    ...
    std::string trim (std::string const &str) {
        ...
        return start != std::string::npos ? str.substr(
                start, 1 + end - start) : std::string();
    }
    ...
    pluralise::pluralise (std::size_t count,
                          std::string const &label)
            : m_count(count),
              m_label(label) {}
...
namespace Catch {
    StringRef::StringRef (char const *rawChars) noexcept
            : StringRef(rawChars,
                        static_cast<StringRef::size_type>(std::strlen(
                                rawChars))) {}
    ...
    auto
    StringRef::currentData () const noexcept -> char const * {
        return m_start;
    }
    ...
    auto StringRef::operator== (
            StringRef const &other) const noexcept -> bool {
        return
                size() == other.size() &&
                (std::strncmp(m_start, other.m_start,
                              size()) == 0);
    }
...
namespace Catch {
    TagAlias::TagAlias (std::string const &_tag,
                        SourceLineInfo _lineInfo) : tag(
...
namespace Catch {
    ...
    RegistrarForTagAliases::RegistrarForTagAliases (
            char const *alias, char const *tag,
            SourceLineInfo const &lineInfo) {
        CATCH_TRY {
            getMutableRegistryHub().registerTagAlias(alias,
                                                     tag,
                                                     lineInfo);
        } CATCH_CATCH_ALL {
...
namespace Catch {
    ...
    TagAlias const *TagAliasRegistry::find (
    ...
    std::string TagAliasRegistry::expandAliases (
        ...
        for (auto const &registryKvp : m_registry) {
            std::size_t pos = expandedTestSpec.find(
                    registryKvp.first);
    ...
    void TagAliasRegistry::add (std::string const &alias,
        ...
        CATCH_ENFORCE(m_registry.insert(
                std::make_pair(alias, TagAlias(tag,
                                               lineInfo))).second,
                      "error: tag alias, '" << alias
                                            << "' already registered.\n"
                                            << "\tFirst seen at: "
...
namespace Catch {
    ...
    namespace {
        ...
        bool isReservedTag (std::string const &tag) {
            return parseSpecialTag(tag) ==
                   TestCaseInfo::None && tag.size() > 0 &&
                   !std::isalnum(
    ...
    TestCase makeTestCase (ITestInvoker *_testCase,
        ...
        for (char c : _descOrTags) {
            if (!inTag) {
                ...
                if (c == ']') {
                    TestCaseInfo::SpecialProperties prop = parseSpecialTag(
                            tag);
                    if ((prop & TestCaseInfo::IsHidden) !=
                        0)
                        isHidden = true;
                    else if (prop == TestCaseInfo::None)
                        enforceNotReservedTag(tag,
                                              _lineInfo);
        ...
        TestCaseInfo info(nameAndTags.name, _className,
                          desc, tags, _lineInfo);
    ...
    TestCase::TestCase (ITestInvoker *testCase,
                        TestCaseInfo &&info) : TestCaseInfo(
...
namespace Catch {
    ...
    std::vector<TestCase> sortTests (IConfig const &config,
        ...
        switch (config.runOrder()) {
            ...
            case RunTests::InRandomOrder:
                seedRng(config);
                std::shuffle(sorted.begin(), sorted.end(),
                             rng());
                break;
    ...
    std::vector<TestCase> const &
    TestRegistry::getAllTestsSorted (
        ...
        if (m_currentSortOrder != config.runOrder() ||
            ...
            m_sortedFunctions = sortTests(config,
                                          m_functions);
...
namespace Catch {
    namespace TestCaseTracking {
        ...
        void TrackerContext::setCurrentTracker (
                ITracker *tracker) {
        ...
        bool
        TrackerBase::isSectionTracker () const { return false; }

        bool
        TrackerBase::isIndexTracker () const { return false; }
        ...
        void TrackerBase::close () {
            ...
            switch (m_runState) {
                ...
                default:
                    CATCH_INTERNAL_ERROR("Unknown state: "
                                                 << m_runState);
            }
            moveToParent();
            m_ctx.completeCycle();
        ...
        bool
        SectionTracker::isSectionTracker () const { return true; }
        ...
        void SectionTracker::tryOpen () {
            if (!isComplete() && (m_filters.empty() ||
                                  m_filters[0].empty() ||
                                  m_filters[0] ==
                                  m_nameAndLocation.name))
                open();
        }
        ...
        bool
        IndexTracker::isIndexTracker () const { return true; }
        ...
        IndexTracker::acquire (TrackerContext &ctx,
            ...
            if (ITrackerPtr childTracker = currentTracker.findChild(
                ...
                assert(childTracker);
                assert(childTracker->isIndexTracker());
                tracker = std::static_pointer_cast<IndexTracker>(
                        childTracker);
            } else {
...
namespace Catch {
    ...
    TestSpec::NamePattern::NamePattern (
            std::string const &name)
            : m_wildcardPattern(toLower(name),
                                CaseSensitive::No) {}

    bool TestSpec::NamePattern::matches (
    ...
    TestSpec::TagPattern::TagPattern (
            std::string const &tag) : m_tag(toLower(tag)) {}

    bool TestSpec::TagPattern::matches (
            TestCaseInfo const &testCase) const {
    ...
    bool TestSpec::ExcludedPattern::matches (
            TestCaseInfo const &testCase) const {
        return !m_underlyingPattern->matches(testCase);
    }

    bool TestSpec::Filter::matches (
            TestCaseInfo const &testCase) const {
...
namespace Catch {
    ...
    void TestSpecParser::visitChar (char c) {
        if (m_mode == None) {
            switch (c) {
                ...
                case '"':
                    return startNewMode(QuotedName,
                                        ++m_pos);
                case '\\':
                    return escape();
                default:
    ...
    TestSpec parseTestSpec (std::string const &arg) {
        return TestSpecParser(
                ITagAliasRegistry::get()).parse(
                arg).testSpec();
    }
...
namespace Catch {
    ...
    namespace {
        auto estimateClockResolution () -> uint64_t {
            ...
            for (std::size_t i = 0; i < iterations; ++i) {
                ...
                if (ticks >
                    startTime + 3 * nanosecondsInSecond) {
                    return sum / i;
                }
            }
    ...
    auto Timer::getElapsedNanoseconds () const -> uint64_t {
        return getCurrentNanosecondsSinceEpoch() -
               m_nanoseconds;
    }
        ...
        namespace {
            ...
            struct Endianness {
                ...
                static Arch which () {
                    ...
                    u.asInt = 1;
                    return (u.asChar[sizeof(int) - 1] == 1)
                           ? Big : Little;
                }
            };
        }
...
# endif
    ...
    std::string StringMaker<wchar_t const *>::convert (
            wchar_t const *str) {
        if (str) {
            return ::Catch::Detail::stringify(
                    std::wstring{str});
    ...
    std::string StringMaker<unsigned int>::convert (
            unsigned int value) {
        return ::Catch::Detail::stringify(
                static_cast<unsigned long long>(value));
    }

    std::string StringMaker<unsigned long>::convert (
            unsigned long value) {
        return ::Catch::Detail::stringify(
                static_cast<unsigned long long>(value));
    }
    ...
    std::string
    ratio_string<std::atto>::symbol () { return "a"; }

    std::string
    ratio_string<std::femto>::symbol () { return "f"; }

    std::string
    ratio_string<std::pico>::symbol () { return "p"; }

    std::string
    ratio_string<std::nano>::symbol () { return "n"; }

    std::string
    ratio_string<std::micro>::symbol () { return "u"; }
...
namespace Catch {
    ...
    bool WildcardPattern::matches (
        ...
        switch (m_wildcard) {
            ...
            case WildcardAtEnd:
                return startsWith(adjustCase(str),
                                  m_pattern);
    ...
    std::string WildcardPattern::adjustCase (
            std::string const &str) const {
...
namespace Catch {
    ...
    XmlEncode::XmlEncode (std::string const &str,
                          ForWhat forWhat)
            : m_str(str),
              m_forWhat(forWhat) {}
    ...
    XmlWriter::ScopedElement::operator= (
            ScopedElement &&other) noexcept {
        if (m_writer) {
            m_writer->endElement();
        }
...
namespace Catch {
    ...
    TestEventListenerBase::getSupportedVerbosities () {
        return {Verbosity::Quiet, Verbosity::Normal,
                Verbosity::High};
    }

    void TestEventListenerBase::assertionStarting (
            AssertionInfo const &) {}

    bool TestEventListenerBase::assertionEnded (
...
namespace {
    ...
    // Colour::LightGrey
    Catch::Colour::Code
    dimColour () { return Catch::Colour::FileName; }
...
// - green: Passed [both/all] N tests cases with M assertions.
        void printTotals (std::ostream &out,
            ...
            if (totals.testCases.total() == 0) {
                ...
                out <<
                    "Failed "
                    << bothOrAll(totals.testCases.failed)
                ...
                out <<
                    "Passed "
                    << bothOrAll(totals.testCases.total())
...
// Implementation of CompactReporter formatting
        ...
        public:
            AssertionPrinter &
            operator= (AssertionPrinter const &) = delete;

            AssertionPrinter (
                    AssertionPrinter const &) = delete;
        ...
        private:
            ...
            void printRemainingMessages (
                ...
                const std::size_t N = static_cast<std::size_t>(std::distance(
                        itMessage, itEnd));
    ...
    void CompactReporter::noMatchingTestCases (
    ...
    bool CompactReporter::assertionEnded (
    ...
    void CompactReporter::sectionEnded (
            SectionStats const &_sectionStats) {
        if (m_config->showDurations() ==
            ShowDurations::Always) {
            stream << getFormattedDuration(
                    _sectionStats.durationInSeconds)
                   << " s: "
...
// Formatter impl for ConsoleReporter
        ...
        private:
            ...
            void printReconstructedExpression () const {
                if (result.hasExpandedExpression()) {
                    ...
                    Colour colourGuard(
                            Colour::ReconstructedExpression);
                    stream << Column(
                            result.getExpandedExpression()).indent(
                            2) << '\n';
                }
            }
        ...
        makeRatio (std::size_t number, std::size_t total) {
            std::size_t ratio =
                    total > 0 ? CATCH_CONFIG_CONSOLE_WIDTH *
                                number / total : 0;
            return (ratio == 0 && number > 0) ? 1 : ratio;
        }

        std::size_t &
        findMax (std::size_t &i, std::size_t &j,
                 std::size_t &k) {
            if (i > j && i > k)
                return i;
            else if (j > k)
        ...
        public:
            explicit Duration (uint64_t inNanoseconds,
                               Unit units = Unit::Auto)
    ...
    public:
        ...
        operator<< (TablePrinter &tp, ColumnBreak) {
            ...
            auto strSize = Catch::StringRef(
                    colStr).numberOfCharacters();
            tp.m_oss.str("");
            tp.open();
            if (tp.m_currentColumn ==
                static_cast<int>(tp.m_columnInfos.size() -
                                 1)) {
            ...
            auto padding = (strSize + 2 <
                            static_cast<std::size_t>(colInfo.width))
                           ? std::string(
                            colInfo.width - (strSize + 2),
                            ' ')
                           : std::string();
    ...
    void ConsoleReporter::noMatchingTestCases (
            std::string const &spec) {
        stream << "No test cases matched '" << spec << '\''
               << std::endl;
    }

    void ConsoleReporter::assertionStarting (
            AssertionInfo const &) {}

    bool ConsoleReporter::assertionEnded (
            AssertionStats const &_assertionStats) {
        AssertionResult const &result = _assertionStats.assertionResult;
        ...
        ConsoleAssertionPrinter printer(stream,
                                        _assertionStats,
                                        includeResults);
        printer.print();
        stream << std::endl;
    ...
    void ConsoleReporter::sectionStarting (
            SectionInfo const &_sectionInfo) {
        m_headerPrinted = false;
        StreamingReporterBase::sectionStarting(
                _sectionInfo);
    }

    void ConsoleReporter::sectionEnded (
            SectionStats const &_sectionStats) {
    ...
    void ConsoleReporter::benchmarkStarting (
            BenchmarkInfo const &info) {
    ...
    void ConsoleReporter::benchmarkEnded (
            BenchmarkStats const &stats) {
        Duration average(stats.elapsedTimeInNanoseconds /
                         stats.iterations);
        (*m_tablePrinter)
                << stats.iterations << ColumnBreak()
                << stats.elapsedTimeInNanoseconds
                << ColumnBreak()
                << average << ColumnBreak();
    }

    void ConsoleReporter::testCaseEnded (
            TestCaseStats const &_testCaseStats) {
        m_tablePrinter->close();
        StreamingReporterBase::testCaseEnded(
                _testCaseStats);
        m_headerPrinted = false;
    }

    void ConsoleReporter::testGroupEnded (
    ...
    void ConsoleReporter::testRunEnded (
            TestRunStats const &_testRunStats) {
    ...
    void ConsoleReporter::printClosedHeader (
            std::string const &_name) {
        printOpenHeader(_name);
        stream << getLineOfChars<'.'>() << '\n';
    }

    void ConsoleReporter::printOpenHeader (
            std::string const &_name) {
        stream << getLineOfChars<'-'>() << '\n';
        {
            Colour colourGuard(Colour::Headers);
...
// subsequent lines
    void ConsoleReporter::printHeaderString (
        ...
        if (i != std::string::npos)
            ...
            i = 0;
        stream << Column(_string).indent(
                indent + i).initialIndent(indent) << '\n';
    }

    struct SummaryColumn {

        SummaryColumn (std::string _label,
                       Colour::Code _colour)
    ...
    ConsoleReporter::printTotals (Totals const &totals) {
        if (totals.testCases.total() == 0) {
            ...
            columns.push_back(
                    SummaryColumn("", Colour::None)
                            .addRow(totals.testCases.total())
                            .addRow(totals.assertions.total()));
            columns.push_back(
                    SummaryColumn("passed", Colour::Success)
    ...
    void ConsoleReporter::printTotalsDivider (
            Totals const &totals) {
        if (totals.testCases.total() > 0) {
...
namespace Catch {
    ...
    bool JunitReporter::assertionEnded (
    ...
    void JunitReporter::testCaseEnded (
    ...
    void JunitReporter::testGroupEnded (
            TestGroupStats const &testGroupStats) {
        double suiteTime = suiteTimer.getElapsedSeconds();
        CumulativeReporterBase::testGroupEnded(
                testGroupStats);
    ...
    void JunitReporter::writeGroup (
        ...
        xml.scopedElement("system-out").writeText(
                trim(stdOutForSuite), false);
        xml.scopedElement("system-err").writeText(
                trim(stdErrForSuite), false);
    }

    void JunitReporter::writeTestCase (
    ...
    void JunitReporter::writeSection (
        ...
        std::string name = trim(
                sectionNode.stats.sectionInfo.name);
        if (!rootName.empty())
            name = rootName + '/' + name;
        ...
        if (!sectionNode.assertions.empty() ||
            ...
            if (!sectionNode.stdOut.empty())
                xml.scopedElement("system-out").writeText(
                        trim(sectionNode.stdOut), false);
            if (!sectionNode.stdErr.empty())
                xml.scopedElement("system-err").writeText(
                        trim(sectionNode.stdErr), false);
        }
    ...
    void JunitReporter::writeAssertions (
            SectionNode const &sectionNode) {
...
namespace Catch {
    ...
    void ListeningReporter::addReporter (
            IStreamingReporterPtr &&reporter) {
        assert(!m_reporter &&
    ...
    void ListeningReporter::benchmarkStarting (
    ...
    void ListeningReporter::testRunStarting (
    ...
    void ListeningReporter::testCaseStarting (
    ...
    void ListeningReporter::sectionStarting (
            SectionInfo const &sectionInfo) {
        for (auto const &listener : m_listeners) {
    ...
    void ListeningReporter::assertionStarting (
    ...
    void ListeningReporter::sectionEnded (
    ...
    void ListeningReporter::testCaseEnded (
            TestCaseStats const &testCaseStats) {
        for (auto const &listener : m_listeners) {
    ...
    void ListeningReporter::testGroupEnded (
            TestGroupStats const &testGroupStats) {
        for (auto const &listener : m_listeners) {
    ...
    void ListeningReporter::testRunEnded (
    ...
    void ListeningReporter::skipTest (
            TestCaseInfo const &testInfo) {
        for (auto const &listener : m_listeners) {
...
namespace Catch {
    ...
    void XmlReporter::noMatchingTestCases (
            std::string const &s) {
        StreamingReporterBase::noMatchingTestCases(s);
    }

    void XmlReporter::testRunStarting (
    ...
    void XmlReporter::sectionStarting (
            SectionInfo const &sectionInfo) {
    ...
    void XmlReporter::assertionStarting (
            AssertionInfo const &) {}

    bool XmlReporter::assertionEnded (
            AssertionStats const &assertionStats) {
    ...
    void XmlReporter::testCaseEnded (
            TestCaseStats const &testCaseStats) {
